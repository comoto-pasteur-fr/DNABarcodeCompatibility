...
* 18 libraries sequenced in multiplex of 3 on a HiSeq (4 channels) platform
```{r, echo=TRUE}
# experiment_design(file1=txtfile, sample_number=18, mplex_level=3, chemistry=4, file2 = txtfile)
```
...
# Compatible combinations after an exhaustive search
system.time(m <- get_random_combinations(index_df = barcodes, mplex_level = 3, chemistry = 4))
head(m)
...
### Constrain barcodes to be robust against one subsitution error 
